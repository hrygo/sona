...
| [声音工坊：示例引导与双路径注册](architecture/voice-studio-guided-creation.md) | 🟢 `active` | `architecture` | `v1.1.0` | 六类示例、生成参考注册、输入/输出验收分离、原始录音电平与失败恢复；实机音质待验收 |
| [声音工坊 UX 分支检查矩阵](architecture/voice-studio-ux-branch-audit.md) | 🟢 `active` | `architecture` | `v1.0.0` | 30 组串联场景、失败复现、恢复路径与真实设备验收边界 |
